export type Project = {
  ...
  /**
   * Factor with which revenues and hourly rates have to multiplicated in order to get the effective
   * values Only with necessary access rights. In case of a project which has a hard budget and has
   * been completed with a budget usage of 400%, the factor is "0.25". "null" if a project with hard
   * budget hasn't been completed yet. "1" for projects without or with soft budget.
   */
