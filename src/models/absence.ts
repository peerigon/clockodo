...
type CommonAbsence = {
  ...
  /**
   * Type of the absence. Only with access rights for absence administration or in case of own
   * absences
   */
  type?: AbsenceType;
  ...
  /**
   * Date at which the absence request has been enquired in YYYY-MM-DD format. Only with access
   * rights for absence administration or in case of own absences
   */
  dateEnquired?: IsoDate | null;
  /**
   * Date at which the absence request has been approved, declined or cancelled in format
   * YYYY-MM-DD. Only with access rights for absence administration or in case of own absences
   */
  dateApproved?: IsoDate | null;
  /**
   * The ID of the co-worker who has approved, declined or cancelled the request. Only with access
   * rights for absence administration or in case of own absences
   */
...
export type DaysAbsence = CommonAbsence & {
  ...
  /**
   * Amount of absence days (null for overtime reduction). Only with access rights for absence
   * administration or in case of own absences
   */
  countDays: number;
  /**
   * Amount of hours of overtime reduction (null in other cases). Only with access rights for
   * absence administration or in case of own absences
   */
  countHours?: null;
  /**
   * Wether or not the absence has a sick note (Only for AbsenceType.SickDay |
   * AbsenceType.SickDayOfChild) Only with access rights for absence administration or in case of
   * own absences
   */
