...
export const ADD_CHANGE_REQUEST = ["date", "usersId", "changes"] as const;
export const APPROVE_CHANGE_REQUEST = ["id"] as const;
export const DECLINE_CHANGE_REQUEST = ["id"] as const;
