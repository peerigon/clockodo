...
export const DELETE_ACCESS_GROUP = ["id"] as const;
export const DELETE_OVERTIME_REDUCTION = ["id"] as const;
export const DELETE_TARGETHOUR = ["id"] as const;
...
export const CREATE_NEXT_PROJECT_INTERVAL = ["id"] as const;
export const SET_PROJECT_BILLED = ["id"] as const;
...
export const EDIT_OVERTIME_REDUCTION = ["id"] as const;
...
export const EDIT_USERS_NONBUSINESS_GROUP = ["id"] as const;
export const EDIT_HOLIDAYS_QUOTA = ["id"] as const;
export const EDIT_HOLIDAYS_CARRYOVER = ["id"] as const;
export const EDIT_TARGETHOUR = ["id", "type", "dateSince"] as const;
export const GET_ABSENCE = ["id"] as const;
export const GET_ABSENCES = [] as const;
export const GET_ACCESS_GROUP = ["id"] as const;
export const GET_ACCESS_GROUPS_CUSTOMERS_PROJECTS = ["accessGroupsId"] as const;
export const GET_ACCESS_GROUPS_SERVICES = ["accessGroupsId"] as const;
...
export const GET_ENTRIES_TEXTS = ["term", "mode"] as const;
...
export const GET_OVERTIME_REDUCTION = ["id"] as const;
...
export const GET_FAVORITE = ["id"] as const;
export const ADD_FAVORITE = ["name", "customersId", "servicesId", "color", "position"] as const;
export const EDIT_FAVORITE = ["id"] as const;
export const DELETE_FAVORITE = ["id"] as const;
export const START_FAVORITE = ["id"] as const;

export const GET_RATE = ["id"] as const;
export const ADD_RATE = ["parentRateId", "hourlyRate"] as const;
export const EDIT_RATE = ["id"] as const;
export const DELETE_RATE = ["id"] as const;
export const SET_DEFAULT_RATE = ["hourlyRate"] as const;
export const SORT_RATE = ["id", "ids"] as const;
