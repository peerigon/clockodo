...
exports.DEACTIVATE_USER = ["userId"];
...
exports.GET_LUMP_SUM = ["lumpSumEntryId", "timeUntil", "timeSince", "userId"];
exports.ADD_LUMP_SUM = ["customerId", "lumpSumAmount", "lumpSumId", "text", "timeSince"];
