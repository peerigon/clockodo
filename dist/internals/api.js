...
const symbols_1 = require("./utilities/symbols");
...
class Clockodo {
    constructor({ user, apiKey }) {
        ...
        this[symbols_1.clockodoApi] = new lib_1.ClockodoLib({ user, apiKey });
    }
    use(plugin) {
        plugin(this[symbols_1.clockodoApi]);
    }
    getAbsence({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_ABSENCE);
            return this[symbols_1.clockodoApi].get("/absences/" + id);
        });
    }
    getAbsences({ year }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ year }, REQUIRED.GET_ABSENCES);
            return this[symbols_1.clockodoApi].get("/absences", { year });
        });
    }
    getClock() {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/clock");
        });
    }
    getClockUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/clock/update");
        });
    }
    getCustomer({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_CUSTOMER);
            return this[symbols_1.clockodoApi].get("/customers/" + id);
        });
    }
    getCustomers() {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/customers");
        });
    }
    getEntry({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_ENTRY);
            return this[symbols_1.clockodoApi].get("/entries/" + id);
        });
    }
    getEntries({ timeSince, timeUntil }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].get("/entries", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    getEntryGroups({ timeSince, timeUntil, grouping }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].get("/entrygroups", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    getProject({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_PROJECT);
            return this[symbols_1.clockodoApi].get("/projects/" + id);
        });
    }
    getSearchTexts(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/searchtexts", options);
        });
    }
    getService({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_SERVICE);
            return this[symbols_1.clockodoApi].get("/services/" + id);
        });
    }
    getServices() {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/services");
        });
    }
    getSingleTargetHourSet({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_SINGLE_TARGET_HOUR_SET);
            return this[symbols_1.clockodoApi].get("/targethours/" + id);
        });
    }
    getTargetHours(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/targethours", options);
        });
    }
    getTaskDuration({ taskCustomerId, taskProjectId, taskServiceId, taskText, taskBillable, }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].get("/tasks/duration", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    getTasks(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/tasks", options);
        });
    }
    getUser({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id }, REQUIRED.GET_USER);
            return this[symbols_1.clockodoApi].get("/users/" + id);
        });
    }
    getUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            return this[symbols_1.clockodoApi].get("/users");
        });
    }
    getUserReport({ id, year }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ id, year }, REQUIRED.GET_USER_REPORTS);
            return this[symbols_1.clockodoApi].get("/userreports/" + id, Object.assign({ year }, options));
        });
    }
    getUserReports({ year }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ year }, REQUIRED.GET_USER_REPORTS);
            return this[symbols_1.clockodoApi].get("/userreports", Object.assign({ year }, options));
        });
    }
    changeClockDuration({ entryId, durationBefore, duration }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].put("/clock/" + entryId, Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    startClock({ customerId, serviceId, billable }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].post("/clock", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    addCustomer({ name }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ name }, REQUIRED.ADD_CUSTOMER);
            return this[symbols_1.clockodoApi].post("/customers", Object.assign({ name }, options));
        });
    }
    addProject({ name, customerId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ name, customerId }, REQUIRED.ADD_PROJECT);
            return this[symbols_1.clockodoApi].post("/projects", Object.assign({ name, customerId }, options));
        });
    }
    addService({ name }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ name }, REQUIRED.ADD_SERVICE);
            return this[symbols_1.clockodoApi].post("/services", Object.assign({ name }, options));
        });
    }
    addUser({ name, number, email, role }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].post("/users", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    addEntry({ customerId, serviceId, billable }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].post("/entries", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    ...
    deleteEntryGroup({ timeSince, timeUntil }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].delete("/entrygroups", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    deleteAbsence({ absenceId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ absenceId }, REQUIRED.DELETE_ABSENCE);
            return this[symbols_1.clockodoApi].delete("/absences/" + absenceId, options);
        });
    }
    editCustomer({ customerId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ customerId }, REQUIRED.EDIT_CUSTOMER);
            return this[symbols_1.clockodoApi].put("/customers/" + customerId, options);
        });
    }
    editProject({ projectId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ projectId }, REQUIRED.EDIT_PROJECT);
            return this[symbols_1.clockodoApi].put("/projects/" + projectId, options);
        });
    }
    editService({ serviceId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ serviceId }, REQUIRED.EDIT_SERVICE);
            return this[symbols_1.clockodoApi].put("/services/" + serviceId, options);
        });
    }
    editUser({ userId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ userId }, REQUIRED.EDIT_USER);
            return this[symbols_1.clockodoApi].put("/users/" + userId, options);
        });
    }
    editEntryGroup({ timeSince, timeUntil }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].put("/entrygroups", Object.assign(Object.assign({}, requiredArguments), options));
        });
    }
    editAbsence({ absenceId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ absenceId }, REQUIRED.EDIT_ABSENCE);
            return this[symbols_1.clockodoApi].put("/absences/" + absenceId, options);
        });
    }
    editEntry({ entryId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            REQUIRED.checkRequired({ entryId }, REQUIRED.EDIT_ENTRY);
            return this[symbols_1.clockodoApi].put("/entries/" + entryId, options);
        });
    }
    getLumpSumEntriesByUserId({ lumpSumEntryId, timeUntil, timeSince, userId, }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].get("/entries/", Object.assign({ filterLumpSumId: lumpSumEntryId, timeSince,
    ...
    addLumpSumEntry({ customerId, projectId, lumpSumAmount, lumpSumId, text, timeSince, userId, }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this[symbols_1.clockodoApi].post("/entries/", Object.assign({ billable: 1, customerId,
                lumpSumAmount,
                lumpSumId,
                text,
                timeSince,
